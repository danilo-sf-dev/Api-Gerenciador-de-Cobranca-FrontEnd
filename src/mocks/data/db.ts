...
export const INITIAL_TITLES: Title[] = [
  ...
  // Overdue (Vencido, up to 2 days: e.g. due 2026-07-19)
  {
    ...
    orderNumber: "PED-1092",
    invoiceNumber: "NF-4502",
    isPaidByRenegotiation: false,
  ...
  // Late (Atraso, 3+ days: e.g. due 2026-07-10)
  {
    ...
    status: "LATE",
    paymentMethod: "CARD",
    orderNumber: "PED-1093",
    invoiceNumber: "NF-4503",
    isPaidByRenegotiation: false,
  ...
  // Paid (Pago)
  {
    ...
    orderNumber: "PED-1094",
    invoiceNumber: "NF-4504",
    isPaidByRenegotiation: false,
  ...
  // Renegotiated (Renegociado)
  {
    ...
    status: "RENEGOTIATED",
    paymentMethod: "BOLETO",
    orderNumber: "PED-1095",
    invoiceNumber: "NF-4505",
    isPaidByRenegotiation: false,
    createdAt: "2026-05-15T16:00:00Z",
    updatedAt: "2026-07-15T10:00:00Z",
  },
  // Children generated from 1005 renegotiation (Upcoming)
  {
    id: "10051",
    customerId: "c-5",
    customerName: "Distribuidora Aliança",
  ...
  // Canceled (Cancelado)
  {
    ...
    status: "CANCELED",
    paymentMethod: "CARD",
    orderNumber: "PED-1096",
    invoiceNumber: "NF-4506",
    isPaidByRenegotiation: false,
...
export const INITIAL_TITLE_HISTORY: TitleHistory[] = [
  ...
  },
  {
    ...
    titleId: "1005",
    status: "RENEGOTIATED",
    reason: "Título renegociado em 2 parcelas (10051, 10052)",
    userName: "Gerente Financeiro",
    createdAt: "2026-07-15T10:00:00Z",
  },
  {
